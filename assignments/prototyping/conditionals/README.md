...
- Get comfortable with conditionals and the glory of choice
- Experimenting with what kinds of things a conditional can "mean"
- Experimenting with which qualities of your program can be affected/controlled by conditionals
- Trying out further interactivity with mouse variables combined with conditionals
...
- Could you now extend on ideas from prior work to add in the idea of conditionals?
- What kinds of *meanings* can be created through conditionals in your program? Personality? Preference? Surprise? Determinism? Possibilities? Humour? Tragedy? Missed opportunities?
...
2. Rename that folder, maybe to `conditionals-prototype-1` or `blueberry-swirl` (you can always rename it later)
3. Put that folder in your repository somewhere sensible like `cart253/prototypes/conditionals/`
